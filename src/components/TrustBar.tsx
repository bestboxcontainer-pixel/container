...
import { PhoneCall, RotateCcw, Truck, Wrench } from "lucide-react";
...
export async function TrustBar() {
  ...
  return (
    <section className="border-b border-border bg-muted">
      <div className="mx-auto grid max-w-screen-xl grid-cols-2 gap-4 px-3 py-4 lg:grid-cols-4">
