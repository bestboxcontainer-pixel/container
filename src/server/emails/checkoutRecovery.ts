  ...
  if (rank === 2) {
    return {
      ...
      paragraphs: [
        ...
        "Gut zu wissen: Der Standardversand ist bei uns immer kostenlos, ohne Mindestbestellwert, und dauert bei vorrätigen Containern 7 bis 10 Werktage. Wer es eilig hat, wählt den Expressversand für 199,00 € (4-5 Werktage). Und Sie haben in jedem Fall 14 Tage Widerrufsrecht, passt der Container nicht, nehmen wir ihn zurück.",
      ],
